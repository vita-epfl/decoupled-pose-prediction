...
class LSTM_local_global(nn.Module):
    def __init__(self, pose_dim=39, embedding_dim=8, h_dim=16, num_layers=1, dropout=0.1):

        super(LSTM_local_global, self).__init__()
        ...
        self.embedding_fn = nn.Sequential(nn.Linear(3, embedding_dim))
        ...
        self.hidden2g = nn.Linear(h_dim, 3)
...
class Encoder(nn.Module):
    def __init__(self, pose_dim=39, h_dim=32, latent_dim=16, num_layers=2, dropout=0.2):
...
class Decoder(nn.Module):
    def __init__(self, pose_dim=39, h_dim=32, latent_dim=16, num_layers=1, dropout=0.2):
